...
const fadeElements = document.querySelectorAll('.ministry-card, .event-card, .service-card, .fusion-feature');
...
if (visitorForm) {
    visitorForm.addEventListener('submit', (e) => {
        ...
        const phone = visitorForm.querySelector('input[type="tel"]').value;
...
// Hide/Show Scroll-to-Top functionality
